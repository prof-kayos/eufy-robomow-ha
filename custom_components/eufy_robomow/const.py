...
# ── Pad direction (mowing path angle) — DP154 ─────────────────────────────────
# DP154 stores the mowing angle as a small integer representing degrees (0–359).
# The app shows a rotary control for a full rotation.
# Confirmed: value 0 = "AA=="  (b'\x00'),  value 1 = "GAE="  (b'\x18\x01')
# The degree values map directly: integer N → N degrees.
PAD_DIRECTION_MIN  =   0   # degrees
PAD_DIRECTION_MAX  = 359   # degrees  (full rotation, 360 = 0)
